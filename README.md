...
The site was deployed to GitHub pages. The steps to deploy a site/ repository are:
  1. In the GitHub repository, navigate to the **Settings** tab on the created repository.
  2. When in Settings, navigate to the **Pages** tab on the left hand side.
  3. Under **Source**, select the branch to **master**, then click **save**.
  4. Once this has been done it will take some time to deploy, once done the repository url link will appear allowing to view the website in a browser as if it is a published website with a domain etc.

### **To create a local clone of this project**
The process of cloning a project from GitHub is:

1. Under the repository’s name, click on the **code** drop down tab.
2. In the **Clone with HTTPS** section, click on the clipboard icon to copy the given URL.
3. In your IDE of choice, open **Git Bash**.
4. Change the current working directory to the location where you want the cloned repositorys directory to be made.
